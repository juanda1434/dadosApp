                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class=" row col-12 col-lg-6 justify-content-center mt-5">
                            <div class="login-box col-12 col-lg-9">
                                ...
                                <div class="card ">
                                    <div class="card-header text-center ">
                                        <h2><b>Panel Control</b> <label id="ms">ms(0)</label></h2>
                                                ...
                                                <div class="col-12">
                                                    <ul class="list-group list-group-unbordered mb-3">
                                                        <li class="list-group-item">
                                                            <b>Codigo de sala</b> <a class="float-right"><span id="lblCodigoSala">Crea una partida</span></a>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <b>Niños unidos</b> <a class="float-right"><span id="lblCantidadNiñosUnidos">Crea una partida</span></a>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <b>Estado</b> <a class="float-right"><span id="lblEstadoSala">Crea una partida</span></a>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <b>Tiempo</b> <a class="float-right"><span id="lblTiempo">esperando...</span></a>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <b>Total partidas jugadas</b> <a class="float-right"><span id="lblTotalJugado">Crea una partida</span></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                    ...
                                    <div class="card-footer">
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-6 mt-3 row justify-content-center">
                                                <button id="btnFinalizarRonda" type="button" class="btn btn-info btn-flat disabled"><i class="fas fa-paper-plane "></i>Finalizar ronda</button>
                                            </div>
                            ...
                            <div class="login-box col-12">
                                ...
                                <div class="card ">
                                    <div class="card-header text-center ">
                                        <h2><b>Tabla de puntuacion</b> <label id="ms"></label></h2>
                        ...
                        <div id="panelCuadro" class="card row col-12 justify-content-center mt-lg-5 d-none" style="background-color: #f4f9f9;">
...
var readGet = function () {
  ...
  return query_string;
            ...
            var numeros = [];
            var imgDados = [];
            var app = {niñosUnidos: 0, enjuego: true, codigoSala: readGet.codigo, estaRuleta: false, fechaFin: null};
            $(() => {
                ...
                $("#btnFinalizarRonda").on("click", (e) => {

                    if (!app.estaRuleta && numeroElegido == -1 && app.enjuego) {
                        activeButton($("#btnIniciarRuleta"), false);
                        $.post("POST/FinalizarRonda", {codigo: app.codigoSala}, (r) => {
                            console.log(r);
                ...
                function getEstadoPartido() {
                    $.get("GET/PartidoActivo/codigo="+app.codigoSala, (r) => {
                        console.log(r);
                        if (r.exito != undefined && !r.exito) {
                            if (app.codigoSala != "") {
                            ...
                            $("#lblCantidadNiñosUnidos").html(0);
                                ...
                                if (r.preguntaactiva != undefined && Object.keys(r.preguntaactiva).length > 0) {
                                    ...
                                    activeButton($("#btnFinalizarRonda"), true);
                                }
...
//                                imageDado.src = `View/Public/img/${d}.png`;
                            ...
                            if (tiempo == 0) {
                                ...
                                $.post("POST/RegistrarPregunta", {dadouno: numerosSeleccionados[1], dadodos: numerosSeleccionados[2], dadotres: numerosSeleccionados[3], dadocuatro: numerosSeleccionados[4], numero: numeroElegido,codigo:app.codigoSala}, (r) => {
                                    if (r.exito != undefined && r.exito) {
                                        $(document).Toasts('create', {
                                            class: 'bg-success',
                                            title: 'Informativo!',
